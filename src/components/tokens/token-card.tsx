      ...
      >
        <div className="flex items-center gap-4 p-4 w-full">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs text-muted-foreground flex items-center min-w-0">
              ...
              <span className="truncate min-w-0 flex-1" title={coin.coinid}>
                {coin.coinid}
              </span>
            </p>
          </div>
