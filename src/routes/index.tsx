...
export default function TokenManager() {
  ...
  const handleGroupTokens = () => {
    console.log("Grouping tokens:", selectedTokens)
    setSelectedTokens([])
  }
  ...
  return (
    <div className="container mx-auto  max-w-2xl">
      ...
      <div className="mb-8 p-6 bg-gradient-to-r from-primary to-primary-foreground rounded-lg shadow-lg">
        <div className="flex items-center justify-between">
          ...
          <ArrowUpDown className="h-8 w-8 text-white opacity-50" />
        </div>
      </div>
      <div className="grid gap-4">
        {balance?.response.map((token) => (
          <Link
            ...
            className="flex items-center justify-between p-4 bg-card rounded-lg shadow transition-all duration-300 ease-in-out hover:bg-card/80 hover:shadow-md hover:scale-[1.02] cursor-pointer"
          >
            <div className="flex items-center space-x-4">
